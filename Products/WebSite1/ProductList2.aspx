                ...
                <ItemTemplate>
                    <tr bgcolor="#ebf2f9">
                        ...
                        <td align="middle" height="24">
                            &nbsp;<a onclick="window.open('ReportOut2.aspx?a=<%=new System.Random().Next(1, 99999) %>&id=<%#Eval("Id") %>','','dialogHeight: 400px, dialogWidth: 400px,resizable: yes, status: no');" style="color:Blue;">出库</a>
                        </td>
                        <td>
                            &nbsp;<%#Eval("LeiBei")%>
                        </td>
