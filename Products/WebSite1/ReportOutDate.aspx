<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportOutDate.aspx.cs" Inherits="ReportOutDate" %>
...
<head runat="server">
    ...
    <script language="JavaScript" type="text/javascript">
        function delOp(id, obj) {
            if (confirm("确定删除吗？")) {
                window.open("ReportOutDel.aspx?id=" + id);
                alert('操作成功');
                delCol();
            }
        }
    ...
    <div>
                ...
                <tr style="height:25px;text-align:left">
                    <td bgcolor="#ebf2f9" height="30">
                        <table cellspacing="0" width="99%" border="0">
                            <tbody>
                                <tr>
                                    <td style="width:100px">日帐表日期：<asp:TextBox ID="txtDate" runat="server" onclick="calendar.show(this);" style="width: 80px"></asp:TextBox>&nbsp;货号：<asp:TextBox ID="txtHuoHao" runat="server"></asp:TextBox>&nbsp;产品名称：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>&nbsp;类别：<asp:DropDownList ID="ddlLeibei" runat="server"></asp:DropDownList>&nbsp;代理商：<asp:DropDownList ID="ddlAgent" runat="server"></asp:DropDownList><asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" Text="查 询" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
        ...
        <table cellspacing="1" cellpadding="3" width="99%" bgcolor="#6298e1" border="0">
            <tr style="height:25px;font-size:14px;">
                ...
                <td align="middle" width="160">
                    <strong><font color="#ffffff">出库时间</font></strong>
                </td>
                <td align="middle" width="100">
                    <strong><font color="#ffffff">出库数量</font></strong>
                </td>
                <td align="middle" width="100">
                    <strong><font color="#ffffff">实际销售价</font></strong>
                </td>
                <td align="middle" width="120">
            ...
            <asp:Repeater ID="rpData" runat="server">
                <ItemTemplate>
                    <tr bgcolor="#ebf2f9" style="height:25px;">
                        <td align="middle" width="60">
                            <a href="ReportOutEdit.aspx?id=<%#Eval("Id") %>" style="color:Blue">修改</a>&nbsp;&nbsp;
