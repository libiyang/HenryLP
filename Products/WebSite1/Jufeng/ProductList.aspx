<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductList.aspx.cs" Inherits="Jufeng_ProductList" %>
                                ...
                                <tr>
                                    <td nowrap>
                                        ...
                                        &nbsp;下单状态：<asp:DropDownList ID="ddlState" runat="server">
                                            ...
                                            <asp:ListItem Text="已下架" Value="3"></asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" Text="查找" />
                                    </td>
                                    <td><a href="ProductAdd.aspx" style="color:Blue">添加新产品</a>&nbsp;&nbsp;<a href="SalesFooterUploadPic.aspx" style="color:Blue" >上传SalesFooter图片</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
        ...
        <table cellspacing="1" cellpadding="3" width="99%" bgcolor="#6298e1" border="0">
            <tr style="height:25px">
                ...
                <td align="middle" width="80">
                    <strong><font color="#ffffff">美金价</font></strong>
                </td>
                ...
                <ItemTemplate>
                    <tr bgcolor="<%#(Container.ItemIndex+1)%2 == 0 ?"#ebf2a9":"#ebf2f9"%>">
                        <td align="middle" height="24">
                            ...
                            <%# GetProductState((DateTime)Eval("UpdateOn"))%>
                        </td>
                        <td>
                            &nbsp;<%#Eval("LeiBei")%>
                        </td>
