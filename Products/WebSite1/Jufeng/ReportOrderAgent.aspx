<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportOrderAgent.aspx.cs" Inherits="Jufeng_ReportOrderAgent" %>
    ...
    <form id="form1" runat="server">
                ...
                <tr style="height:25px;text-align:left">
                    <td bgcolor="#ebf2f9" height="30">
                        <table cellspacing="0" width="99%" border="0">
                            <tbody>
                                <tr>
                                    <td style="width:100px">帐表日期：<asp:TextBox ID="txtDate" runat="server" onclick="calendar.show(this);" style="width: 80px"></asp:TextBox>—<asp:TextBox ID="txtDate2" runat="server" onclick="calendar.show(this);" style="width: 80px"></asp:TextBox>&nbsp;货号：<asp:TextBox ID="txtHuoHao" runat="server"></asp:TextBox>&nbsp;产品名称：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>&nbsp;类别：<asp:DropDownList ID="ddlLeibei" runat="server"></asp:DropDownList>&nbsp;<asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" Text="查 询" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
        ...
        <table cellspacing="1" cellpadding="3" width="99%" bgcolor="#6298e1" border="0">
            <tr style="height:25px;font-size:14px;">
                ...
                <td align="middle" width="120">
                    <strong><font color="#ffffff">下单时间</font></strong>
                </td>
