<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportOut2.aspx.cs" Inherits="ReportOut2" %>
...
<body>
    ...
    <div>
        <table cellspacing="1" cellpadding="3" width="99%" bgcolor="#6298e1" border="0">
            ...
            <tr bgcolor="#ebf2f9"><td>代理商：</td><td><asp:CheckBoxList ID="cbAgent" runat="server" RepeatColumns="6" RepeatDirection="Horizontal"></asp:CheckBoxList></td></tr>
