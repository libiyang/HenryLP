...
<body>
    ...
    <div>
        ...
        <tr bgcolor="#ebf2f9"><td>产品重量</td><td><asp:TextBox ID="txtWeight" runat="server" Text="0"></asp:TextBox>Kg</td></tr>
        ...
        <tr bgcolor="#ebf2f9"><td>备注说明</td><td><asp:TextBox ID="txtRemark" runat="server"></asp:TextBox></td></tr>
            <tr bgcolor="#ebf2f9">
                <td>
                    图片
                </td>
