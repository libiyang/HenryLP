<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesFooterUploadPic.aspx.cs" Inherits="SalesFooterUploadPic" %>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#uploadify1").uploadify({
                ...
                'script': '/UploadFilesSalesFooterYG.aspx',
        ...
        function fun1(event, queueID, fileObj, response, data) {
            var Image = "<img id='img" + queueID + "' width='216px' src='/PPic/SalesFooter/" + response + "'/>";
